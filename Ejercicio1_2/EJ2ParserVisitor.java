...
public interface EJ2ParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link EJ2Parser#bucle_mientras}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBucle_mientras(EJ2Parser.Bucle_mientrasContext ctx);
	/**
	 * Visit a parse tree produced by {@link EJ2Parser#bucle_para}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBucle_para(EJ2Parser.Bucle_paraContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link EJ2Parser#expr_general}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExpr_general(EJ2Parser.Expr_generalContext ctx);
}