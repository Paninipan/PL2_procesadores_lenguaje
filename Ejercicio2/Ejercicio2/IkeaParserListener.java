...
public interface IkeaParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link IkeaParser#mod_espacio}.
	 * @param ctx the parse tree
	 */
	void enterMod_espacio(IkeaParser.Mod_espacioContext ctx);
	/**
	 * Exit a parse tree produced by {@link IkeaParser#mod_espacio}.
	 * @param ctx the parse tree
	 */
	void exitMod_espacio(IkeaParser.Mod_espacioContext ctx);
}