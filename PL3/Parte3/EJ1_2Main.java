...
/**
 * EJ1_2Main
 * Punto de entrada para el ejercicio 1_2.
 * - Genera el AST legible en un fichero de salida (solo si no hay errores léx./sint.).
...
public class EJ1_2Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        EJ1_2Parser.ProgramaContext tree = parser.programa();
