...
public class EJ1_2MiErrorListener extends BaseErrorListener {
    ...
    private boolean hasErrors = false; //Flag para saber si se ha producido algún error

    public boolean hasErrors() {
        return hasErrors; //Getter para que el main pueda consultarlo
    }
    ...
    public void syntaxError(Recognizer<?, ?> recognizer,
        ...
        System.err.println("Tipo: " + tipo + ". línea " + line + ":" + charPositionInLine + " -> " + msg);
    }
}
