...
public class ParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements ParserVisitor<T> {
	 ...
	 */
	@Override public T visitArchivo(ParserJava.ArchivoContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitFila(ParserJava.FilaContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitCampo(ParserJava.CampoContext ctx) { return visitChildren(ctx); }
}