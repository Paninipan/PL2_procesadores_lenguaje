...
public class ParserJava extends Parser {
	...
	public ParserJava(TokenStream input) {
		super(input);
	...
	public static class ArchivoContext extends ParserRuleContext {
		public TerminalNode EOF() { return getToken(ParserJava.EOF, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ParserListener ) ((ParserListener)listener).enterArchivo(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ParserListener ) ((ParserListener)listener).exitArchivo(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitArchivo(this);
	...
	public static class FilaContext extends ParserRuleContext {
		...
		public TerminalNode SALTO_DE_LINEA() { return getToken(ParserJava.SALTO_DE_LINEA, 0); }
		public List<TerminalNode> SEPARADOR() { return getTokens(ParserJava.SEPARADOR); }
		public TerminalNode SEPARADOR(int i) {
			return getToken(ParserJava.SEPARADOR, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ParserListener ) ((ParserListener)listener).enterFila(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ParserListener ) ((ParserListener)listener).exitFila(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitFila(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CampoContext extends ParserRuleContext {
		public TerminalNode TEXTO() { return getToken(ParserJava.TEXTO, 0); }
		public TerminalNode STRING() { return getToken(ParserJava.STRING, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ParserListener ) ((ParserListener)listener).enterCampo(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ParserListener ) ((ParserListener)listener).exitCampo(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitCampo(this);
			else return visitor.visitChildren(this);
		}
	}
